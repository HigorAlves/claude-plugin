...
description: Expert analysis of type design -- encapsulation, invariant expression, usefulness, and enforcement. Use when introducing new types, during PR creation, or when refactoring existing types.
model: inherit
color: pink
maxTurns: 15
permissionMode: plan
