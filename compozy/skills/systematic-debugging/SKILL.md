...
1. **Create Failing Test Case**
   ...
   - Use the `compozy:tdd` skill for writing proper failing tests
...
**When you see these:** STOP. Return to Phase 1. You skipped the process.
...
**Related skills:**
- **compozy:tdd** — For creating failing test case (Phase 4, Step 1)
- **compozy:verification** — Verify fix worked before claiming success
