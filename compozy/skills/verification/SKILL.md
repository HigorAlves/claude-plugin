...
False completion claims break trust and ship broken code:
- Undefined functions shipped → crashes in production
- Missing requirements shipped → incomplete features
- Time wasted on false completion → redirect → rework
- "Honesty is a core value. Evidence before claims, always."
...
- Paraphrases and synonyms ("everything looks good", "should be working")
