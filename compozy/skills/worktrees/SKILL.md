...
**Announce at start:** "I'm using the worktrees skill to set up an isolated workspace."
...
2. ~/worktrees/<project-name>/ (global location, outside project)
3. Custom location
...
```
You: I'm using the worktrees skill to set up an isolated workspace.
...
**Called by:**
- `compozy:orchestrate` (Phase 0, optional)
- Any workflow needing isolated workspace

**Pairs with:**
- **compozy:branch-completion** — Cleans up worktree after work complete
