...
**Consider:** Integration tests with real components are often simpler than complex mocks. If mock setup dominates the test, the mock is hiding design complexity — simplify the design or test with real components.
